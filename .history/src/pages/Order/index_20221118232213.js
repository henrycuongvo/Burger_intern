    ...
    <>
      ...
      <table className={cx("burger_detail")}>
        <tr>
          ...
          <td>
            {" "}
            <Button less onClick={() => changeValue(SALAD, -1)}>
              Less
            </Button>
          </td>
          <td>
            {" "}
            <Button more onClick={() => changeValue(SALAD, +1)}>
              More
            </Button>
          </td>
        </tr>
        <tr>
          ...
          <td>
            {" "}
            <Button less onClick={() => changeValue(BACON, -1)}>
              Less
            </Button>
          </td>
          <td>
            {" "}
            <Button more onClick={() => changeValue(BACON, +1)}>
              More
            </Button>
          </td>
        </tr>
        <tr>
          ...
          <td>
            {" "}
            <Button less onClick={() => changeValue(CHEESE, -1)}>
              Less
            </Button>
          </td>
          <td>
            {" "}
            <Button more onClick={() => changeValue(CHEESE, +1)}>
              More
            </Button>
          </td>
        </tr>
        <tr>
          ...
          <td>
            {" "}
            <Button less onClick={() => changeValue(MEAT, -1)}>
              Less
            </Button>
          </td>
          <td>
            {" "}
            <Button more onClick={() => changeValue(MEAT, +1)}>
              More
            </Button>
          </td>
        </tr>
