...
export default function BurgerBuilder() {
    ...
    console.log('🚀 ~ file: index.js ~ line 24 ~ BurgerBuilder ~ getCart', getCart);
    console.log(getCart);
    const cart = {
        salad: 0,
        bacon: 0,
                    ...
                    <table className={cx('selection')}>
                        <tr>
                            ...
                            <td>
                                ...
                                <Button
                                    less
                                    onClick={() => handlechangeValue(dispatch(increment()))}
                                >
                                    Less
                                </Button>
                            </td>
                            <td>
                                {' '}
                                <Button more onClick={() => handlechangeValue()}>
                                    More
                                </Button>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <Button more onClick={() => dispatch(increment(setCart))}>
                                    TestMore
                                </Button>
                            </td>
                        </tr>
